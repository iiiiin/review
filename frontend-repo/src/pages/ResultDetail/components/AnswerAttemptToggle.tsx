...
import { FileText, Award, Lightbulb, Info } from 'lucide-react';
...
interface AnswerAttemptToggleProps {
  feedbacks: Feedback[];
...
export default function AnswerAttemptToggle({
  feedbacks,
  ...
  const videoId = `q${currentQuestionIndex}-f${selectedAttempt}`;
                ...
                {feedback.videoUrl && (
                  <div>
                    ...
                    <video 
                      ...
                      onLoadedMetadata={(e) => {
                        console.log(`비디오 ${videoId} 메타데이터 로드됨:`, e.currentTarget.duration);
                      }}
                      onError={(e) => {
                        console.error(`비디오 ${videoId} 로드 오류:`, e);
                      }}
                    >
