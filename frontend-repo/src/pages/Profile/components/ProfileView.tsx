...
import { getMyPageDataAPI } from '@/pages/Profile/api/profile';
import type { Profile, Summary } from '@/shared/types/user';
// import type { Document } from '@/shared/types/document';

import DocumentsList from '@/pages/Profile/components/DocumentsList';
...
const ProfileInfoContent = ({ profile }: ProfileInfoProps) => {
  ...
  console.log('loginType:', profile?.loginType);
