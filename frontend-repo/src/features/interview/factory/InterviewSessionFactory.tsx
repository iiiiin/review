...
import GeneralInterviewSession from '@/features/interview/components/session/GeneralInterview/GeneralInterviewSession';
import PTInterviewSession from '@/features/interview/components/session/PTInterview/PTInterviewSession';
import type { 
  InterviewType, 
  InterviewSessionProps,
  GeneralInterviewSessionProps,
  PTInterviewSessionProps 
} from '@/features/interview/interfaces/InterviewInterface';
