...
import type { UseRecordingOptions } from '../hooks/useRecording';
import { useTimer } from '../hooks/useTimer';
import { useWebSocketConnection } from '../hooks/useWebSocketConnection';
import type { UseWebSocketConnectionOptions } from '../hooks/useWebSocketConnection';
import { useSessionManager } from '../hooks/useSessionManager';
import type { UseSessionManagerOptions } from '../hooks/useSessionManager';
...
export const InterviewProvider: React.FC<InterviewProviderProps> = ({
  ...
  const session = useSessionManager(
    ...
    (readySessionId: string) => {
      console.log('🔗 세션 준비 완료:', readySessionId);
    },
    (error: any) => {
